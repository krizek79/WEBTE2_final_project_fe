        ...
        const handleAddClick = (id) => {
            setOptions((prevOptions) =>
                prevOptions.map((option) =>
                    option.id === id ? {...option, showInput: !option.showInput} : option
                )
            );
        };
                    ...
                    <div className="bg-white pt-12 pr-0 pb-12 pl-0 mt-0 mr-auto mb-0 ml-auto sm:py-16 lg:py-20">
                        <div className="pt-0 pr-4 pb-0 pl-4 mt-0 mr-auto mb-0 ml-auto max-w-7xl sm:px-6 lg:px-8">
                            <div className="max-w-2xl pt-0 pr-4 pb-0 pl-4 mt-0 mr-auto mb-0 ml-auto sm:px-6 lg:px-8">
                                <div
                                    className="bg-light shadow-xl mt-8 mr-0 mb-0 ml-0 pt-4 pr-10 pb-4 pl-10 flow-root rounded-lg sm:py-2">
                                    <div className="pt--10 pr-0 pb-10 pl-0">
                                        <div className="pt-5 pr-0 pb-0 pl-0 mt-5 mr-0 mb-0 ml-0">
                                            {options.map((option) => (
                                                <div key={option.id}>
                                            <div className="flex mt-4 sm:items-center sm:justify-between sm:space-x-5">
                                                    ...
                                                    <div className="flex items-center flex-1 min-w-0" >
                                                        ...
                                                        <div
                                                            ...
                                                            <label
                                                                htmlFor={option.id}
                                                                className={`select-none cursor-pointer rounded-lg border-2 border-dark py-3 px-6 font-bold transition-colors duration-200 ease-in-out ${
                                                                    option.showInput
                                            ...
                                            <div className="flex flex-col items-center">
                                                <button type="submit"
                                                        className="mt-10 rounded-md bg-dark px-10 py-2 text-white hover:bg-azure ">Send
                                                    to students
                                                </button>
                                            </div>
                                        </div>
